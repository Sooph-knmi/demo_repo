...
class DDPGroupStrategy(DDPStrategy):
    ...
    def setup(self, trainer: pl.Trainer) -> None:
        ...
        comms_groups_ranks = np.split(np.arange(0, self.world_size), int(self.world_size / self.mgroup_size))
        ...
        self.model.set_comm_group_def((comms_group, len(my_mgroup), my_mgroup_rank), (comms_groups_single[my_rank], 1, 0))
